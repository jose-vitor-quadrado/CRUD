...
namespace Blog.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAsync([FromServices] BlogDataContext context)
        {
            ...
            {
                return StatusCode(500, "05X08 - Falha interna no servidor");
            }
        }

        [HttpGet("v1/categories/{id:int}")]
        public async Task<IActionResult> GetByIdAsunc([FromRoute] int id, [FromServices] BlogDataContext context)
        {
            try
            {
            ...
            {
                return StatusCode(500, "05X09 - Falha interna no servidor");
            }
        }
        ...
        public async Task<IActionResult> PutAsync([FromRoute] int id, [FromBody] Category model, [FromServices] BlogDataContext context)
        {
            ...
            {
                return StatusCode(500, "05XE8 - Não foi possível atualizar a categoria");
            }
            catch (Exception ex)
            {
